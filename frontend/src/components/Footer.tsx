...
export function Footer() {
  ...
  if (isAuthenticated) {
    return (
      <footer className="bg-surface border-t border-border mt-auto bg-primary-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex justify-between items-center">
            <p className="text-sm text-primary-600">
              © {new Date().getFullYear()} Resume Match AI. All rights reserved.
            </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-xl font-bold mb-4">Resume Match AI</h3>
            <p className="text-primary-300 mb-4">
              AI-powered resume and job matching platform that helps companies
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="https://x.com/krisnarenaldi"
                target="_blank"
                rel="noopener noreferrer"
                className="text-primary-300 hover:text-accent-400 transition-colors"
                aria-label="Twitter"
